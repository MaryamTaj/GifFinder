...
submitButton.addEventListener("click", async (e) => {
  let myKey = "RBUOrV1UKuRyxiMFoQu2sSZcTW2Da1sS";
  // By adding a phrase to the queryField.value, the image develops a theme (e.g. "fail videos")
  let topic = queryField.value + "fail";
  console.log(topic);
